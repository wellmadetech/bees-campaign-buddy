...
const BUNDLES: Bundle[] = [
  {
    ...
    featured: true,
    campaigns: [
      { id: 'sb-1', title: 'Game Day Beer Deals — Pre-game Push', type: 'Ad-hoc Sales', status: 'draft', scheduledDate: 'Feb 1' },
      { id: 'sb-2', title: 'Super Bowl Party Pack Email', type: 'Ad-hoc Sales', status: 'draft', scheduledDate: 'Feb 3' },
      { id: 'sb-3', title: 'Last Call — Order by Thursday', type: 'Ad-hoc Operational', status: 'draft', scheduledDate: 'Feb 6' },
      { id: 'sb-4', title: 'Game Day In-App Banner', type: 'Ad-hoc Sales', status: 'draft', scheduledDate: 'Feb 9' },
      { id: 'sb-5', title: 'Post-Game Thank You + Reorder', type: 'Lifecycle', status: 'draft', scheduledDate: 'Feb 10' },
    ],
  },
  {
    id: 'b2',
    ...
    status: 'active',
    campaigns: [
      { id: 'cm-1', title: 'Early Bird — Cinco de Mayo Stock Up', type: 'Ad-hoc Sales', status: 'launched', scheduledDate: 'Apr 28' },
      { id: 'cm-2', title: 'Corona Bundle Spotlight', type: 'Ad-hoc Sales', status: 'launched', scheduledDate: 'May 1' },
      { id: 'cm-3', title: 'Last Chance Delivery Cutoff', type: 'Ad-hoc Operational', status: 'in_progress', scheduledDate: 'May 3' },
      { id: 'cm-4', title: 'Cinco de Mayo Day-of Push', type: 'Ad-hoc Sales', status: 'draft', scheduledDate: 'May 5' },
    ],
  },
  {
    id: 'b3',
    ...
    status: 'upcoming',
    campaigns: [
      { id: 'wc-1', title: 'World Cup Kickoff — Opening Day Deals', type: 'Ad-hoc Sales', status: 'draft', scheduledDate: 'Jun 11' },
      { id: 'wc-2', title: 'Match Day Bundle — Group Stage', type: 'Ad-hoc Sales', status: 'draft', scheduledDate: 'Jun 14' },
      { id: 'wc-3', title: 'Weekly Scorecard + Reorder Reminder', type: 'Lifecycle', status: 'draft', scheduledDate: 'Jun 18' },
      { id: 'wc-4', title: 'Round of 16 Special', type: 'Ad-hoc Sales', status: 'draft', scheduledDate: 'Jun 28' },
      { id: 'wc-5', title: 'Quarter-Final Watch Party Pack', type: 'Ad-hoc Sales', status: 'draft', scheduledDate: 'Jul 4' },
      { id: 'wc-6', title: 'Semi-Final Countdown', type: 'Ad-hoc Sales', status: 'draft', scheduledDate: 'Jul 8' },
      { id: 'wc-7', title: 'Final Weekend Blowout', type: 'Ad-hoc Sales', status: 'draft', scheduledDate: 'Jul 18' },
      { id: 'wc-8', title: 'Post-Tournament Thank You', type: 'Lifecycle', status: 'draft', scheduledDate: 'Jul 19' },
    ],
  },
  {
    id: 'b4',
    ...
    status: 'upcoming',
    campaigns: [
      { id: 'xm-1', title: 'Holiday Season Kickoff', type: 'Ad-hoc Sales', status: 'draft', scheduledDate: 'Dec 1' },
      { id: 'xm-2', title: 'Holiday Hours Notice', type: 'Ad-hoc Operational', status: 'draft', scheduledDate: 'Dec 15' },
      { id: 'xm-3', title: 'Last Order Before Christmas', type: 'Ad-hoc Operational', status: 'draft', scheduledDate: 'Dec 20' },
      { id: 'xm-4', title: 'Christmas Week Celebration Deals', type: 'Ad-hoc Sales', status: 'draft', scheduledDate: 'Dec 23' },
      { id: 'xm-5', title: 'New Year Eve Party Pack', type: 'Ad-hoc Sales', status: 'draft', scheduledDate: 'Dec 29' },
      { id: 'xm-6', title: 'Happy New Year — Start 2027 Right', type: 'Lifecycle', status: 'draft', scheduledDate: 'Jan 2' },
    ],
  },
];
